<template>
    <div class="m-publish-zlp">
        <el-form-item :label="$t('publish.form.expansion')">
            <el-select v-model="zlp" filterable size="large" :allow-create="true" :placeholder="$t('publish.form.expansionPlaceholder')">
