<template>
    <div class="m-publish-box" v-loading="loading">
        ...
        <publish-header name="剑三茶馆">
            <publish-revision :enable="true" type="bbs" :post-id="id"></publish-revision>
        </publish-header>
...
import bbs_types from "@/assets/data/publish/bbs.json";
...
// import publish_topic_bucket from "@/components/publish/publish_topic_bucket.vue";
import publish_guide from "@/components/publish/publish_guide.vue";

// 数据逻辑
import { push, getTopicBucket, pushAdmin } from "@/service/publish/cms.js";
