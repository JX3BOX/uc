<template>
    <div class="m-publish-box" v-loading="loading">
        <!-- 头部 -->
        <publish-header :name="$t('publish.types.tools')">
            <div class="u-actions">
        ...
        <el-form label-position="left" label-width="80px">
            ...
            <div class="m-publish-info">
                ...
                ></publish-tool-source>
                <!-- 作业模式 -->
                <el-form-item :label="$t('publish.form.extension')" v-if="post.post_subtype == 3">
                    <el-checkbox v-model="post.homework" :true-value="1" :fasle-value="0">{{ $t("publish.form.homeworkMode") }}</el-checkbox>
                </el-form-item>
            </div>
