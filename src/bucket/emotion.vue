<template>
    <div class="m-dashboard-work m-dashboard-cms">
        <div class="m-dashboard-work-header">
            <h2 class="u-title">{{ $t("publish.types.emotes") }}</h2>
            <a :href="publishLink" class="u-publish el-button el-button--primary">
                <i class="el-icon-document"></i> {{ $t("publish.emotion.publish") }}
            </a>
        </div>
...
<script>
import { getMyEmotions, deleteEmotion } from "@/service/publish/pvx.js";
                    ...
                    if (action == "confirm") {
                        deleteEmotion(id).then((res) => {
                            this.$notify({
                                ...
                                message: this.$t("publish.emotion.deleteSucceeded"),
                                type: "success",
                            });
